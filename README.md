...
7. Industry Practices:
	- separate raw and cleaned data - do not overwrite.
	- logging to show when pipeline started, what went one, and when it finished.
	- configuration file.
	- reproducibility: someone should be able to run requirements.txt (pip install -r requirements.txt)
		and the pipeline.
	- data quality checks.
